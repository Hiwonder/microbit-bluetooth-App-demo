...
public class PromptDialog extends BaseDialog {
    ...
    public static DialogFragment create (Context context, FragmentManager fm, String title, CharSequence content, DialogInterface.OnClickListener onClickListener){
    ...
    public static DialogFragment create (Context context, FragmentManager fm, String title, CharSequence content,
                                         String leftText, String rightText, DialogInterface.OnClickListener onClickListener){
