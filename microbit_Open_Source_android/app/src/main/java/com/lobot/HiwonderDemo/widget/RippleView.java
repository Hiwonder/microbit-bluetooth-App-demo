...
import com.lobot.HiwonderDemo.util.DensityUtils;
...
public class RippleView extends View {
    ...
    private void init() {
        ...
        mDensity = DensityUtils.dp2px(mContext, mDensity);
...
//        Log.e("6666", "mRipples.size:" + mRipples.size());
        // 处理每个圆的宽度和透明度
        ...
        if (mRipples.size() > 0) {
            // 控制第二个圆出来的间距
            if (mRipples.get(mRipples.size() - 1).width > DensityUtils.dp2px(mContext, mDensity)) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (myWidthSpecMode == MeasureSpec.EXACTLY) {
            ...
            // wrap_content
            mWidth = DensityUtils.dp2px(mContext, 120);
        }
        ...
        if (myHeightSpecMode == MeasureSpec.EXACTLY) {
            ...
            // wrap_content
            mHeight = DensityUtils.dp2px(mContext, 120);
        }
